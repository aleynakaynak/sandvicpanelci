...
export const CATEGORY_MAP: Record<string, CatNode> = {
  'sandvic-panel-kaplama-malzemeleri': {
    ...
    children: [
      ...
      { slug: 'cephe-panelleri', name: 'Cephe Panelleri', description: 'Modern cephe kaplama ve yalıtım panelleri.', image: '/images/products/pur-cephe-gallery.png', children: [] },
    ],
  },
  'cati-panelleri': {
    slug: 'cati-panelleri',
    ...
    children: [
      ...
      { slug: 'ekonomik-cati-panel', name: 'Ekonomik Çatı Paneli (7 Hadveli)', description: 'Bütçe dostu, 7 hadveli standart izolasyonlu hafif çatı kaplama çözümü.', image: '/images/products/ekonomik-cephe-panel.jpg', children: [] },
    ],
  },
  'cephe-panelleri': {
    ...
    image: '/images/products/pur-cephe-gallery.png',
    children: [
      { slug: 'pur-pir-yalitimli-cephe-panelleri', name: 'PUR/PIR Yalıtımlı Cephe Panelleri', description: 'Yüksek performanslı PUR/PIR cephe paneli.', image: '/images/products/pur-cephe-gallery.png', children: [] },
      { slug: 'mineral-yun-yalitimli-cephe-panelleri', name: 'Mineral Yün Yalıtımlı Cephe Panelleri', description: 'Yangına dayanıklı mineral yün cephe paneli.', image: '/images/products/mineral-cephe-gallery.png', children: [] },
      { slug: 'ekonomik-cephe-panel', name: 'Ekonomik Cephe Panel', description: 'Uygun fiyatlı cephe kaplama çözümü.', image: '/images/products/ekonomik-cephe-gallery.jpg', children: [] },
    ],
  },
  'trapez-saclar': {
    slug: 'trapez-saclar',
